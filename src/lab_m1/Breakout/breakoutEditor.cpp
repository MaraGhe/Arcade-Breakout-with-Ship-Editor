...
using namespace breakoutEditor;

BreakoutEditor::BreakoutEditor()
{
}
...
void BreakoutEditor::Init(float X, float Y, float width, float height, float unit,
...
void BreakoutEditor::removeBlock(int blockX, int blockY)
{
    modifyGrid(blockX, blockY, 0);
}

void BreakoutEditor::placeBlock(int blockX, int blockY)
{
    modifyGrid(blockX, blockY, 1);
}

void BreakoutEditor::validateBuild()
{
...
void BreakoutEditor::createShipMesh(std::unordered_map<std::string, Mesh*>& meshes, 
