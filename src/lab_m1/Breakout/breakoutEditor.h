...
namespace breakoutEditor
{
	class BreakoutEditor : public gfxc::SimpleScene
	{
	public:
		BreakoutEditor();
		~BreakoutEditor();

		// sets the coordinates & creates the meshes for the breakoutEditor
		...
		// breakoutEditor screen coordinates & size
