...
void Breakout::Init(float X, float Y, float width, float height, float unit,
...
void Breakout::gameLogicUpdate(float deltaTimeSceonds)
{
    if (!gameRunning)
        return;
...
void Breakout::moveShip(const std::string& direction)
{
...
void Breakout::changeAngleHorizontal()
{
...
void Breakout::changeAngleVertical()
{
